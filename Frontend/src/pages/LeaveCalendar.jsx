        ...
        <div className="bg-white shadow-xl  rounded-b-2xl overflow-hidden">
                  ...
                  <>
                    ...
                    <AnimatePresence>
                      {dayData.leaves.map((leave, leaveIndex) => {
                        const LeaveIcon =
                          leaveTypes[leave.type]?.icon || MoreHorizontal;
          ...
          <div className="bg-gray-50 p-3 sm:p-4">
            <h2 className="text-base sm:text-lg font-semibold mb-2 sm:mb-3 flex items-center text-gray-800">
              <Users className="mr-1 sm:mr-2 text-indigo-600 w-4 h-4 sm:w-5 sm:h-5" />{" "}
              Leave Overview
            </h2>
            <div className="grid grid-cols-3 gap-2 sm:gap-3">
              ...
              >
                ...
                <div>
                  <div className="font-bold text-emerald-800 text-[10px] sm:text-xs">
                    Approved
                  </div>
              ...
              >
                ...
                <div>
                  <div className="font-bold text-amber-800 text-[10px] sm:text-xs">
                    Pending
                  </div>
              ...
              >
                ...
                <div>
                  <div className="font-bold text-rose-800 text-[10px] sm:text-xs">
                    Rejected
                  </div>
            ...
            >
              ...
              >
                <div className="flex items-center mb-3 sm:mb-4">
                  {React.createElement(
                    leaveTypes[selectedLeave.type]?.icon || MoreHorizontal,
                    {
                      className: `mr-2 sm:mr-3 w-6 h-6 sm:w-8 sm:h-8 text-${
                        leaveTypes[selectedLeave.type]?.color || "gray"
                      }-600`,
                    }
                  )}
                  <div>
                ...
                <div className="space-y-1.5 sm:space-y-2">
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold text-xs sm:text-sm">
                      {selectedLeave.startDate.toDateString()}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600 text-xs sm:text-sm">
                    ...
                    <span className="font-semibold text-xs sm:text-sm">
                      {selectedLeave.endDate.toDateString()}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600 text-xs sm:text-sm">
                ...
                <div className="grid grid-cols-3 gap-2 mb-4">
                  {monthNames.map((month, index) => (
                    <button
                      key={month}
                      onClick={() =>
                        handleDirectDateSelect(index, selectedYear)
                      }
                ...
                <div className="grid grid-cols-3 gap-2">
                  {yearRange.map((year) => (
                    <button
                      key={year}
                      onClick={() =>
                        handleDirectDateSelect(selectedMonth, year)
                      }
                      className={`p-2 rounded ${
                        selectedYear === year
                          ? "bg-indigo-500 text-white"
